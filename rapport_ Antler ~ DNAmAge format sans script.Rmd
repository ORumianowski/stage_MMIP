...
```{r}
reg_lm1 <- lm(AgeAccelLOO ~ Antler_std + Population + Weight + Cohort + Cohort_Type +
                Antler_std:Population + Antler_std:Weight  ,  
             data=data_antler)
...
```{r}
reg_lm2 <- lm(AgeAccelLOO ~ Antler_std + Population + Weight + Cohort_Type +
                AgeClass + Antler_std:AgeClass +
                Antler_std:Population + Antler_std:Weight,  
             data=data_antler)
