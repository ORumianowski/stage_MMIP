...
Differentes fonctions ont été testées pour suivre au mieux la dynamique de croissance i.e. $ AntlerLength = f(JulianDate) $. La longueur des bois a été log-transformée. Quatre fonctions ont été testées: (i) constante, (ii) linéraire, (iii) une pente avec plateau et (iv) deux pentes.
...
Les modèles sont testés sur les données en discriminant selon la population d'origine et sinon la mesure a été ralisé sur un premère année ou non i.e. partionnement en quatre du jeu de données.

Les mesures effectuées sur des individus ayant des bois secs ont été retirés de l'analyse. La mesure brute sera directement utilisée en tant mesure standard.

Les mesures effectuées sur des individus ayant des bois inférieurs à 1cm ont été retirés de l'analyse. La mesure brute sera directement utilisée en tant mesure standard.
...
L'anaylse des AIC et des graphes révèlent que le modèle linéaire est le plus adapté, excepté pour le groupe d'adulte provenant de Chizé où le meilleur modèle correspond à la fonction constante. Pour ce groupe, la mesure brute sera directement utilisée en tant mesure standard.
...
### Création d'indices d'accéléation de l'âge épigénétique et d'allocation vers la production de bois

Les résidus d'un modèle linéaireliant le l'âge épigénétique avec une fonction de l'âge ont été utlisés pour obtenir un indice d'accéléation de l'âge épigénétique.

Les résidus d'un modèle linéaireliant le la longueur des bois standardisés avec une fonction de la masse ont été utlisés pour obtenir un indice d'allocation vers la production de bois.
...
reginvess = lm(Antler_std ~ Weight, data_antler)
...
### Exploration graphiques des relations entre l'accélération de l'âge épigénétique et la qualité de bois.
