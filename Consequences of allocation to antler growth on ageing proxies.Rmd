...
The AIC and graph analysis revealed that the linear model is the best fit, except for the group of adults from Chizé where the best model corresponds to the constant function. 
...
The cross-validation revealed that the second function called Logarithmic shows the best performance (Figure!!!). Surprisingly, the Horvath function presents an intermediate performance. 
