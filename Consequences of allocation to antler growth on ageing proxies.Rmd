...
Evolutionary theories of senescence, i.e. Antagonistic Pleiotropic Theory, Disposable Soma Theory, consider that aging emerges from the trade-off between reproduction in early life and in late life (Williams 1957, Kirkwood & Rose 1991, see Lemaître et al. 2015 for a review). Therefore, because of sexual selection is associed with a diversity of cost (Garratt & Brooks, 2012), high allocation to precopulatory competition including production and maintenance of secondary sexual traits (SST) is expected to correlate with senescence intensity. In mammals, the strenght of sexual selection negatively influenced the onset of senescence, and males of  polygynous species having an earlier onset of senescence than in monogamous species (Clutton-Brock & Isvaran 2007; Tidière et al., 2015). In an intraspecific perpective, sexual selection  might explained partially between-sex difference in senescence pattern. Males with a high investment in precopulatory behavior suffer from a strengthened senescence. For example, in red deer, males which had larger harems experienced higher rates of senescence in both harem size and rut duration. (Lemaître et al., 2014). Studies on  the cost associated with the development of SST have revealed diverse physiological costs (Garratt & Brooks, 2012). However, long-term costs were only unveiled from demographic studies (Lemaître et al., 2018). Very few studies have brought information able to determine if these long-term costs are physiological and what are the underlying mechanisms. 

A first approach to fill this gap is to know if the intensity of production and maintenance of SST affects proxies of aging. For example, in the Australian painted dragon (Ctenophorus pictus), males that maintained a high level of head coloration suffered from a rapid rate of telomere loss  (Giraudeau et al., 2016). Although the relation between telomere dynamics and individual life history is still highly discussed, telomere shortening correlates with increased mortality risk and is usually perceived as a good biomarker for explaining reproductive costs (Sudyka, 2019).  Based on the level of cytosine methylation at some selected CpG sites, highly accurate epigenetic age estimators recently developed offer another promising proxy to study the process of biological aging in ecology and evolution (Parrott and Bertucci, 2019). By interpreting the degree of epigenetic-to-chronological age discordance as a result of individual age acceleration, it can be used to quantify physiological long-term cost (Gibson et al. 2019).
...
Relative telomere length (hereafter RTL) was measured by quantitative PCR as previously described for these populations (Wilbourn et al. 2017). Genomic DNA was extracted from white blood cells . We measured relative leukocyte telomere length (RTL) using a real-time quantitative PCR method (qPCR; Cawthon 2002) which has previously been optimized and validated in sheep and cattle (Seeker et al. 2016 ) and previously used in roe deer (Wilbourn et al. 2017 ). This method measures the total amount of telomeric sequence present in a DNA sample relative to the amount of a non-variable copy number reference gene (beta-2-microglobulin (B2M)). B2M was previously identified as an appropriate reference gene for use in qPCRstudies of telomere length in sheep (Fairlie et al. 2016) and cattle (Seeker et al. 2018, Seeker et al., 2016).
...
Male allocation to precopulatory sexual competition is assumed to explain male biais in intensity of senescence of mammals.In roe deer, demographic analysis suggested that high allocation to antler growth is associated with a lower probability to reach the age of 6. Nevertheless, our results have not revealed any significant association between allocation to antler growth and both proxies of aging i.e. epigenetic age deviation and annual RTL variation. Therefore, we found no evidence that allocation to antler growth constitutes a physiological cost for roe deer. 

Surprisingly, our results suggest that RTL is not associated with age in roe deer. For a majority of individuals, telomere length increased with age (60%, n=25). While measurement error could contribute to such an apparent elongation of telomere length, increasing RTL might result from a possible expression of telomerase. Still, our knowledge on telomerase is limited and unclear (no expression in the fibroblast of Munjac species, Gomes et al. 2011; expression in the antler of Sika deer, Sun et al. 2010). A significant difference of RTL was found between the two populations, individuals from Triois-Fontaines Forest having longer RTL. This result might be explained by the higher habitat quality of the forest. 

Epigenetic age deviation was not explained by any explanatory variables invoked in the study.
